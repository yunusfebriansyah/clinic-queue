      ...
      <div class="card-body">
        ...
        <form method="post" action="/doctor/treatments/{{ $treatment->id }}">
          ...
          <div class="form-group">
            <label for="disease">Isi Penyakit</label>
            <input type="text" name="disease" id="disease" class="form-control @error('disease') is-invalid @enderror" required placeholder="Isi penyakit yang diderita pasien"/>
            @error('disease')
