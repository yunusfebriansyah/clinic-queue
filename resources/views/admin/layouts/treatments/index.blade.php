...
<div class="row justify-content-end">
  <div class="col-12 col-md-6 col-xl-4">
    <form action="/administrator/treatments" method="get">
...
<div class="row justify-content-end mb-3">
  <div class="col-12">
    <a target="_blank" href="/administrator/treatments/print?date={{ request('date') }}" class="btn btn-danger float-right"><i class="fas fa-print"></i> Cetak PDF</a>
  </div>
</div>
