...
Route::put('/doctor/change-password', [DoctorDashboardController::class, 'updatePassword'])->middleware('is_doctor');
Route::get('/doctor/treatments/print', [DoctorTreatmentController::class, 'print'])->middleware('is_doctor');
