...
class DoctorDashboardController extends Controller
{
    ...
    public function index()
    {
        return view('doctor.layouts.index', [
            ...
            'is_done_treatments' => count(Treatment::where('doctor_id', auth()->user()->id)->where('status', '!=', 'ditolak')->where('status', '!=', 'dibatalkan')->where('status', '!=', 'menunggu konfirmasi')->where('status', '!=', 'menunggu antrian')->where('status', '!=', 'ditangani')->get()),
